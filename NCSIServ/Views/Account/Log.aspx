...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <% if ((int)ViewData["page"] > 0)
       { %>
       <a href="/Account/Log/<%=(int)ViewData["page"] - 1%>">Prev</a>
    <% } %>
    <% if ((ViewData["Accesses"] as IQueryable<NCSIServ.Controllers.AccountController.AccessData>).Count() == 20)
       { %>
       <a href="/Account/Log/<%=(int)ViewData["page"] + 1%>">Next</a>
    <% } %>
    <% }
       else
       { %>
